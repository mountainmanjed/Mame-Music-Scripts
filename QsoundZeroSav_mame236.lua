...
function main()
  ...
  if keyboard == 1 then
    ...
    gui:draw_box(300, 0, 384, 32, 0xFFFFFFFF, 0xC0EE00DD)
...
function drawkeyboard(kbx, kby, octaves)
  WKeysC1, WKeysC2 = 0xFFAAAAAA, 0xFFFFFFFF 
  BKeysC1, BKeysC2 = 0xFF777777, 0xFF000000
...
function playkeyboard(id, x, y)
  ...
  if active ~= 0 then
    gui:draw_box(x, y, x + 180, y + 10, 0xFFFFFF00, 0xFF0000FF)
    gui:draw_text(x + 02, y + 2, string.format("%01X", id))
    drawkeyboard(x + 40, y + 2, 4)

    if setting3 < 5 then
      gui:draw_text(x + 12, y + 2, cps2notes[note1 + 1])
      gui:draw_text(x + 22, y + 2, tostring(octave))
      gui:draw_text(x + 30, y + 2, tostring(notef1))
      drawplaynote(notef1, x + 40, y + 2, 0xFF880000,0xFFFF0000)
      drawplaynote(notef2, x + 40, y + 2, 0xFF008800,0xFF00FF00 )
    end
  end
...
function drawplaynote(mnote, x, y, color1, color2)
  ...
  gui:draw_box(x1, y1, x2, y2, color2, color1)
